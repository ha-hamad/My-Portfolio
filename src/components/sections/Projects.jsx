        ...
        >
            ...
            <div className="max-w-5xl mx-auto px-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="p-6 rounded-xl border border-white/10 hover:bg-blue-500/20 hover:-translate-y-1 hover:border-cyan-500 hover:shadow-[0_2px_8px_rgba(59,130,246,0.2)] transition-all flex flex-col">
                    ...
                    <div className="p-6 rounded-xl border border-white/10 hover:bg-blue-500/20 hover:-translate-y-1 hover:border-cyan-500 hover:shadow-[0_2px_8px_rgba(59,130,246,0.2)] transition-all flex flex-col">
                        ...
                        <div className="flex-grow flex flex-col justify-end">
                            <div className="flex flex-wrap gap-2">
                                {["Python", "Matplotlib", "Seaborn", "Pandas", "Sklearn"].map((tech, key) => (
                                    <span key={key} className="bg-blue-500/10 text-blue-500 py-1 px-3 rounded-full text-sm hover:bg-blue-500/20 hover:shadow-[0_2px_8px_rgba(59,130,246,0.1)] transition-all">
                                        {tech}
                                    </span>
                                ))}
